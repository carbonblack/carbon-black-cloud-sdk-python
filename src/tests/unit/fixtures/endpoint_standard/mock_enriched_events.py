    ...
    'results': [
                {
                    ...
                    'parent_name': 'c:\\users\\dragon\\.rustup\\toolchains\\stable-x86_64-pc-windows-msvc\\bin\\cargo.exe', 
                    'parent_pid': 8188, 
                    'parent_publisher_state': ['FILE_SIGNATURE_STATE_NOT_SIGNED'], 
                    'parent_reputation': 'ADAPTIVE_WHITE_LIST', 
                    'process_cmdline': ['"C:\\Users\\dragon\\.rustup\\toolchains\\stable-x86_64-pc-windows-msvc\\bin\\rustc.exe"'], 
                    ...
                    'process_hash': ['0dde659f0854d78f137119e13e1368ef', 'de74b04a291133b8c6c5a30bff6b2cef8ad4141cd1813d063c8c62f2671652e8'], 
                    ...
                    'ttp': ['ADAPTIVE_WHITE_APP', 'MITRE_T1059_CMD_LINE_INTER', 'RUN_CMD_SHELL']
                 }
               ],         
    'num_found': 1, 
    'num_available': 1, 
