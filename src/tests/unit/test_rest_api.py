...
from tests.unit.fixtures.mock_rest_api import (NOTIFICATIONS_RESP, AUDITLOGS_RESP, ALERT_SEARCH_SUGGESTIONS_RESP,
                                               PROCESS_SEARCH_VALIDATIONS_RESP, CUSTOM_SEVERITY_RESP,
                                               PROCESS_LIMITS_RESP, FETCH_PROCESS_QUERY_RESP, CONVERT_FEED_QUERY_RESP)
...
def test_custom_severities(cbcsdk_mock):
    ...
    api = cbcsdk_mock.api
    cbcsdk_mock.mock_request("GET", "/threathunter/watchlistmgr/v3/orgs/test/reports/severity",
...
def test_process_limits(cbcsdk_mock):
    ...
    api = cbcsdk_mock.api
    cbcsdk_mock.mock_request("GET", "/api/investigate/v1/orgs/test/processes/limits",
                                    PROCESS_LIMITS_RESP)
...
def test_convert_feed_query(cbcsdk_mock):
    """Tests getting process queries"""
    api = cbcsdk_mock.api
    cbcsdk_mock.mock_request("POST", "/threathunter/feedmgr/v2/query/translate",
