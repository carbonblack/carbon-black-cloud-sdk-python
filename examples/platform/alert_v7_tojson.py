    ...
    if alert_v6 == alert_v6_from_v7:
        ...
        for f in alert_v6:
            ...
            # fields from cb analytics that are not in v7. No mapping available
                    ...
                    or f == "threat_activity_c2" or f == "threat_activity_dlp" or f == "threat_activity_phish" or f == "threat_cause_vector"):
                if f in alert_v6_from_v7:
            ...
            # fields from watchlist alert that are not in v7. No mapping available
            elif f == "count" or f == "document_guid" or f == "threat_cause_vector" or (f == "threat_indicators" and alert_v6["type"] == "WATCHLIST"):
                if f in alert_v6_from_v7:
                    print(
                ...
                if alert_v6_from_v7[f] != alert_v6[f]:
                    if isinstance(alert_v6[f], dict) or isinstance(alert_v6_from_v7[f], dict):
                        ...
                        for i in v6_inner:
                            if v6_inner[i] is not None and (i not in v6_from_v7_inner or v6_inner[i] != v6_from_v7_inner[i]):
                                print("inner value not matched for field {}".format(i))
                                # print("Field {} value error.  v6 \n{} is different to v6_from_v7 \n{} \n".format(f, alert_v6[f], alert_v6_from_v7[f]))
                del alert_v6_from_v7[f]
            elif alert_v6[f] is None:
                a=1
                # print("{} has None value. Not required.  Correct".format(f))
            else:
...
def main():
    ...
    # container_runtime_alert_id = "46b419c8-3d67-ead8-dbf1-9d8417610fac" # org_key = VZMTPVJZR2, profile CONTAINER_RUNTIME
    ...
    # python3 examples/platform/alert_v7_tojson.py --profile CONTAINER_RUNTIME --alert_id 46b419c8-3d67-ead8-dbf1-9d8417610fac
    ...
    alert_json_compare(path, "v6_alert-CB_ANALYTICS-6f1173f5-f921-8e11-2160-edf42b799333.json", "v6_by_v7_alert-CB_ANALYTICS-6f1173f5-f921-8e11-2160-edf42b799333.json", "v7_alert-CB_ANALYTICS-6f1173f5-f921-8e11-2160-edf42b799333.json")
    # Watchlist
    print("")
    print("Watchlist Alert Comparison")
    alert_json_compare(path, "v6_alert-WATCHLIST-f6af290d-6a7f-461c-a8af-cf0d24311105.json","v6_by_v7_alert-WATCHLIST-f6af290d-6a7f-461c-a8af-cf0d24311105.json","v7_alert-WATCHLIST-f6af290d-6a7f-461c-a8af-cf0d24311105.json")
    # CONTAINER_RUNTIME
    print("")
    print("Container Runtime Alert Comparison")
    print("Containers not run")
    # alert_json_compare(path, "v6_alert-CONTAINER_RUNTIME-46b419c8-3d67-ead8-dbf1-9d8417610fac.json","v6_by_v7_alert-CONTAINER_RUNTIME-46b419c8-3d67-ead8-dbf1-9d8417610fac.json","v7_alert-CONTAINER_RUNTIME-46b419c8-3d67-ead8-dbf1-9d8417610fac.json")
    # DEVICE_CONTROL
    print("")
    print("Device Control Alert Comparison")
    alert_json_compare(path,"v6_alert-DEVICE_CONTROL-b6a7e48b-1d14-11ee-a9e0-888888888788.json", "v6_by_v7_alert-DEVICE_CONTROL-b6a7e48b-1d14-11ee-a9e0-888888888788.json", "v7_alert-DEVICE_CONTROL-b6a7e48b-1d14-11ee-a9e0-888888888788.json")
    # HBFW
    print("")
    print("Host Based Firewall Alert Comparison")
    alert_json_compare(path,"v6_alert-HOST_BASED_FIREWALL-2be0652f-20bc-3311-9ded-8b873e28d830.json", "v6_by_v7_alert-HOST_BASED_FIREWALL-2be0652f-20bc-3311-9ded-8b873e28d830.json", "v7_alert-HOST_BASED_FIREWALL-2be0652f-20bc-3311-9ded-8b873e28d830.json")
